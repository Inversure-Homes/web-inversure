...
urlpatterns = [
    ...
    path("proyectos/<int:proyecto_id>/liquidaciones/", views.proyecto_liquidaciones, name="proyecto_liquidaciones"),
    ...
    path(
        "proyectos/<int:proyecto_id>/participaciones/<int:participacion_id>/contrato/",
        views.contrato_prestamo,
        name="contrato_prestamo",
    ),
    path(
        "proyectos/<int:proyecto_id>/participaciones/<int:participacion_id>/contrato/emitir/",
        views.contrato_emitir,
        name="contrato_emitir",
    ),
    path(
        "proyectos/<int:proyecto_id>/participaciones/<int:participacion_id>/rescision/",
    ...
    # token hace de credencial. Esta vista escribe cifras del proyecto, así que
    # no puede vivir en esa zona.
    path(
        "inversores/<int:perfil_id>/beneficio/<int:participacion_id>/",
        views.inversor_beneficio_update,
        name="inversor_beneficio_update",
    ),
